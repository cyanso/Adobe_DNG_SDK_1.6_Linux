  ...
  {                                                                            \
    ...
    if (errMessage && strlen(errMessage) <= 128) {                             \
      if (!silent) {                                                           \
        char errBuffer[256];                                                   \
        sprintf(errBuffer,                                                     \
                "Info: XMP " routine " threw '%s' exception",                  \
                errMessage);                                                   \
...
void
dng_xmp_sdk::InitializeSDK(dng_xmp_namespace* extraNamespaces,
                           const char* software)
{
  ...
  if (!gInitializedXMP) {
    ...
    try {
...

      {
        ...
        SXMPMeta::RegisterNamespace(XMP_NS_CRLCP, "crlcp", &ss);
      }
...

      {
        ...
        SXMPMeta::RegisterNamespace(XMP_NS_LR, "lr", &ss);
      }
...

      {
        ...
        SXMPMeta::RegisterNamespace(XMP_NS_GPANO, "GPano", &ss);
      }
...

      {
        ...
        SXMPMeta::RegisterNamespace(XMP_NS_REGIONS, "mwg-rs", &ss);
      }
      ...
      if (extraNamespaces != NULL) {
        ...
        for (; extraNamespaces->fullName != NULL; ++extraNamespaces) {
          ...
          SXMPMeta::RegisterNamespace(
            extraNamespaces->fullName, extraNamespaces->shortName, &ss);
        }
      }
...
void
dng_xmp_sdk::Parse(dng_host& host, const char* buffer, uint32 count)
{
...
void
dng_xmp_sdk::AppendArrayItem(const char* ns,
                             ...
                             bool propIsStruct)
{
  ...
  try {
    ...
    fPrivate->fMeta->AppendArrayItem(ns,
                                     ...
                                     itemValue,
                                     propIsStruct ? kXMP_PropValueIsStruct : 0);
  }
...
int32
dng_xmp_sdk::CountArrayItems(const char* ns, const char* path) const
{
...
bool
dng_xmp_sdk::Exists(const char* ns, const char* path) const
{
...
bool
dng_xmp_sdk::HasNameSpace(const char* ns) const
{
...
void
dng_xmp_sdk::Remove(const char* ns, const char* path)
{
...
void
dng_xmp_sdk::RemoveProperties(const char* ns)
{
  ...
  if (HasMeta()) {
    ...
    try {
      ...
      SXMPUtils::RemoveProperties(
        fPrivate->fMeta, ns, NULL, kXMPUtil_DoAllProperties);
...
bool
dng_xmp_sdk::IsEmptyString(const char* ns, const char* path)
{
...
bool
dng_xmp_sdk::IsEmptyArray(const char* ns, const char* path)
{
          ...
          if (fPrivate->fMeta->GetArrayItem(ns, path, 1, &ss, &options)) {
            ...
            if (XMP_PropIsSimple(options)) {
              ...
              if ((ss.c_str() == 0 || ss.c_str()[0] == 0)) {
                ...
                if (!fPrivate->fMeta->GetArrayItem(
                      ns, path, 2, &ss, &options)) {
...
void
dng_xmp_sdk::ComposeArrayItemPath(const char* ns,
                                  const char* arrayName,
                                  int32 index,
                                  dng_string& s) const
{
...
void
dng_xmp_sdk::ComposeStructFieldPath(const char* ns,
...
bool
dng_xmp_sdk::GetNamespacePrefix(const char* uri, dng_string& s) const
{
...
bool
dng_xmp_sdk::GetString(const char* ns, const char* path, dng_string& s) const
{
...
void
dng_xmp_sdk::ValidateStringList(const char* ns, const char* path)
{
...
bool
dng_xmp_sdk::GetStringList(const char* ns,
                           const char* path,
...
bool
dng_xmp_sdk::GetAltLangDefault(const char* ns,
                               const char* path,
                               dng_string& s,
                               bool silent) const
{
  ...
  if (HasMeta()) {
    ...
    try {
      ...
      if (fPrivate->fMeta->GetLocalizedText(
            ns, path, "x-default", "x-default", NULL, &ss, NULL)) {
...
bool
dng_xmp_sdk::GetLocalString(const char* ns,
                            const char* path,
    ...
    try {
      ...
      if (count > 1) {
        ...
        for (int32 index = 1; index <= count; index++) {
          ...
          if (fPrivate->fMeta->GetQualifier(
                ns, arrayItemPath.Get(), kXMP_NS_XML, "lang", &langS, NULL)) {
            ...
            if (fPrivate->fMeta->GetProperty(
                  ns, arrayItemPath.Get(), &tranS, NULL)) {
...
bool
dng_xmp_sdk::GetStructField(const char* ns,
                            const char* path,
                            const char* fieldNS,
                            const char* fieldName,
                            dng_string& s) const
{
  ...
  if (HasMeta()) {
    ...
    try {
      ...
      if (fPrivate->fMeta->GetStructField(
            ns, path, fieldNS, fieldName, &ss, NULL)) {
...
void
dng_xmp_sdk::Set(const char* ns, const char* path, const char* text)
{
...
void
dng_xmp_sdk::SetString(const char* ns, const char* path, const dng_string& s)
{
...
void
dng_xmp_sdk::SetStringList(const char* ns,
                           const char* path,
...
void
dng_xmp_sdk::SetAltLangDefault(const char* ns,
                               const char* path,
                               const dng_string& s)
{
  ...
  try {
    ...
    fPrivate->fMeta->SetLocalizedText(
      ns, path, "x-default", "x-default", ss.Get());
  }
...
void
dng_xmp_sdk::SetLocalString(const char* ns,
                            const char* path,
                            const dng_local_string& s)
{
  ...
  try {
    ...
    for (uint32 index = 0; index < s.TranslationCount(); index++) {
      ...
      fPrivate->fMeta->SetProperty(
        ns, arrayItemPath.Get(), s.Translation(index).Get());
...
void
dng_xmp_sdk::SetStructField(const char* ns,
                            const char* path,
                            const char* fieldNS,
                            const char* fieldName,
                            const char* text)
...
void
dng_xmp_sdk::DeleteStructField(const char* ns,
                               const char* structName,
                               const char* fieldNS,
                               const char* fieldName)
{
...
dng_memory_block*
dng_xmp_sdk::Serialize(dng_memory_allocator& allocator,
                       bool asPacket,
                       uint32 targetBytes,
                       uint32 padBytes,
                       bool forJPEG,
  ...
  if (HasMeta()) {
    ...
    if (asPacket && targetBytes) {
      ...
      try {
        ...
        fPrivate->fMeta->SerializeToBuffer(
          &s, formatOption | kXMP_ExactPacketLength, targetBytes, "", " ");
    ...
    if (!havePacket) {
      ...
      try {
        ...
        fPrivate->fMeta->SerializeToBuffer(
          &s,
          formatOption | (asPacket ? 0 : kXMP_OmitPacketWrapper),
          (asPacket ? padBytes : 0),
          "",
          " ");
      }
...
void
dng_xmp_sdk::PackageForJPEG(dng_memory_allocator& allocator,
...
void
dng_xmp_sdk::MergeFromJPEG(const dng_xmp_sdk* xmp)
{
...
void
dng_xmp_sdk::ReplaceXMP(dng_xmp_sdk* xmp)
{
...
bool
dng_xmp_sdk::IteratePaths(IteratePathsCallback* callback,
                          void* callbackData,
  ...
  if (HasMeta()) {
    ...
    try {
      ...
      SXMPIterator iter(*fPrivate->fMeta,
                        startingNS,
                        startingPath,
                        justChildren ? kXMP_IterJustChildren : 0);
...
void
dng_xmp_sdk::DuplicateSubtree(const dng_xmp_sdk& source,
                              const char* sourceNS,
...
void
dng_xmp_sdk::DocOpsOpenXMP(const char* srcMIME)
{
...
void
dng_xmp_sdk::DocOpsPrepareForSave(const char* srcMIME,
                                  const char* dstMIME,
                                  bool newPath)
{
...
void
dng_xmp_sdk::DocOpsUpdateMetadata(const char* srcMIME)
{
